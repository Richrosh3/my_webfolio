...
export default function Project({
  ...
  return (
    ...
    >
      <section
        ref={ref}
        className="bg-blue-50 max-w-[42rem] borderBlack overflow-hidden sm:pr-8 relative sm:h-[20rem] 
                    sm:group-even:pl-8 hover:bg-sky-100 transition rounded-lg dark:bg-white/10 dark:hover:bg-white/20 dark:text-white"
      >
