...
export default function Header() {
    ...
    return (
        ...
        <header className="z-[999] relative">
            ...
            <nav className="flex fixed top-[.15 rem] left-1/2 h-12 -translate-x-1/2 py-2 sm:top-[1.7rem] sm:h-[initial] sm:py-0">
                            ...
                            >
                                {link.name}
                                {
                                    link.name === activeSection && (
                                        <motion.span
                                            className="bg-sky-200 rounded-full absolute inset-0 -z-10 dark:bg-gray-800"
